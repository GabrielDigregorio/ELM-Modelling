...
Point(10) = {Shield_Length/2, -4, 0, 1.0}; Point(11) = {-Shield_Length/2, -4, 0, 1.0}; // bottom point plate
Point(12) = {-Shield_Length/2, -l+Shield_Thickness, 0, 1.0};// left first plate height
Point(13) = {-Shield_Length/2, -l+2*Shield_Thickness, 0, 1.0};// left second plate height
Point(14) = {Shield_Length/2, -l+Shield_Thickness, 0, 1.0};// right second plate height
Point(15) = {Shield_Length/2, -l+2*Shield_Thickness, 0, 1.0}; // right first plate height

Line(14) = {11, 12}; Line(15) = {12, 13}; Line(16) = {13, 15};
Line(17) = {15, 14}; Line(18) = {14, 10}; Line(19) = {12, 14};

Circle(5) = {3, 1, 2}; Circle(6) = {4, 1, 2}; // sky Domain left
...
// Physical boundaries
Physical Line("GammaInf", 101) = {5, -6, 13};
