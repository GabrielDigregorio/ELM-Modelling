...
DefineConstant[
  ...
  R_out_value = {5.7595, Min 1e-6, Max 1e9, Step 1,
  ...
  { Name Map_a; NameOfPostProcessing Magnetodynamics2D_av;
    Operation {
      ...
      ElseIf (type_Source == 2)
		...
		Print[ norm_of_b, OnLine { {-width_window-width_Core_Leg/2,0,0} {-width_window-width_Core_Leg/2,height_Core-width_Core_Leg/2,0} } {1000}, Format Table, File >"b_norm_line.txt"];
      EndIf
    }
  }
}
