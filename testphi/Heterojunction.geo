...
Point(4) = { -x_n,0, 0}; // upper point
Point(5) = { x_p,0, 0}; // bottom point
Line(1) = {2,4};
Line(2) = {5,3};
Line(3) = {4,1};
Line(4) = {1,5};
Physical Line("N_region", 103) = {1,3};
Physical Line("P_region", 104) = {2,4};
Physical Line("P_region_no_dpl", 105) = {2};
Physical Line("N_region_no_dpl", 106) = {1};
Physical Line("P_region_dpl", 107) = {4};
Physical Line("N_region_dpl", 108) = {3};
Physical Point("V_n", 101) = {2};
Physical Point("V_p", 102) = {3};
Transfinite Line{1,2} =100;
Transfinite Line{3,4} =20;
