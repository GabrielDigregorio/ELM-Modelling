% Gather all parameters of the semiconductors

%% General
q =1.6021766208e-19;% [C] absolute value of the chanrge electrons
epsilon_0 = 8.85418782e-12*1e-6; % [cm-3 kg-1 s4 A2] vacuum permitivity
T = 500; %[K]
k_b = 1.3806e-23; 
...
%% ZnO Type 
thickness_ZnO = 100e-9*1e2; %[cm]
epsilon_r_ZnO = 8;
m_star_e_ZnO =  0.23*m0;
m_star_h_ZnO =  0.8*m0;
N_a_ZnO = 0;
N_d_ZnO = 4e19;
p_ZnO = NaN;
